...
const BottomNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around">
      ...
      <button onClick={()=>navigate("/orders")} className="flex items-center justify-center text-[#ababa] w-[200px]">
        <MdOutlineReorder className="inline mr-2" size={20} /> <p>Orders</p>
      </button>
      <button onClick={()=>navigate("/tables")} className="flex items-center justify-center text-[#ababa] w-[200px]">
        <MdTableBar className="inline mr-2" size={20} /> <p>Tables</p>
      </button>
      <button className="flex items-center justify-center text-[#ababa] w-[200px]">
        <CiCircleMore className="inline mr-2" size={20} /> <p>More</p>
      </button>
      <button onClick={openModel} className="absolute bottom-3 bg-[#F6B100] text-[#F5F5F5] rounded-full p-3 items-center">
        <BiSolidDish size={40} />
      </button>
